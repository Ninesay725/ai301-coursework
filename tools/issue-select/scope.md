...
I have used Java, Python, TypeScript/JavaScript, and SQL. I have built backend services with Spring Boot, NestJS, and Django REST Framework. My work includes APIs, login features, database queries, and real-time updates with WebSocket and SSE. I have also used LangChain, LangGraph, and RAG in AI projects. I have checked my work with unit tests, API and integration tests, and end-to-end tests in staging. For my first contribution, I would like a small backend or RAG data-processing fix with clear expected results and focused tests. I want to get better at reading an unfamiliar codebase and checking that a change works.
